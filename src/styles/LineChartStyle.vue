                ...
                <div style="margin-top:70px">
                  ...
                  <div v-show="openDataOptions" v-for="(y,index) in yAxis" :key="index">
                    ...
                    <div style="position: relative;">
                        <div class="floating">
                          <span @click="showDataColor(index)" class="color" :style="'background:'+(y.border_color ? y.border_color : borderColor[index])" style="border:1px solid #bdbdbd"/>
                          <input id="input__color" class="floating__input" name="title" type="text" placeholder="GRAPH COLOR" :value="y.border_color ? y.border_color : borderColor[index]"/>
