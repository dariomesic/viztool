        ...
        <transition name="slide">
            <div v-if="isBurgerActive" class="sidebar-panel">
              <a @click="this.isBurgerActive = false" class="close"/>
                <li class="style-name">
                  <img :src="require(`@/assets/icon-bar-chart.png`)" style="width:25px;height:25px;margin-right:5px">
                ...
                <div style="margin-top : 50px">
                  ...
                  <div v-show="openGeneralOptions">
                    ...
                    <div class="floating" style="margin-top:35px">
                      <span class="color checkbox">
                        <input type="checkbox" id="checkbox" :checked="(Column.rotation === '' || Column.rotation === true) ? true : false" style="margin-left:0px;top:-15px;" @change="$emit('setObject',{type : 'rotation', objects : $event.target.checked})">
                        <label for="checkbox" style="top: -20px;right: 5px;"></label>
                      </span>
                      <input id="input__rotate" class="floating__input" name="title" type="text" placeholder="Bi-Directional" readonly/>
                      <label for="input__rotate" class="floating__label" data-content="BI-DIRECTIONAL"></label>
                    </div>
                  ...
                  <div style="margin-top:70px">
                    <div class="tree-view-item-node" @click.stop="this.openGraphOptions = !this.openGraphOptions">         	
                      <span :class="{opened: openGraphOptions}" style="background:none;padding-left:5px" class="tree-view-item-key tree-view-item-key-with-chevron-1"><h3 class="text-bold-main style-black">Graph Options</h3></span>
                    </div>
                    <div v-show="openGraphOptions">
                      <div>
                        ...
                        <div>
                          <Slider 
                            ...
                            :max="this.max"
                            :value="this.value"
                            @setyAxisRange="$emit('setObject',{type : 'yAxisRange', objects : $event})"
                          />
...
export default{
  ...
  computed:{
    min: function () {
      if(typeof this.column.initialYAxisRange !== 'undefined'){
        return this.column.initialYAxisRange.min
      }
      return ''
    },
    max: function () {
      if(typeof this.column.initialYAxisRange !== 'undefined'){
        return this.column.initialYAxisRange.max
      }
      return ''
    },
    value: function () {
